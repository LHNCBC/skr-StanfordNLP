...
public class CoreNLPProcess {
    private static Logger log = Logger.getLogger(CoreNLPProcess.class.getName());

    private static CoreNLPProcess coreNLP = null;
    private static StanfordCoreNLP pipeline = null;
    private static TreebankLanguagePack tlp = new PennTreebankLanguagePack();

    private CoreNLPProcess(Properties props) {
	pipeline = new StanfordCoreNLP(props);
    }

    private CoreNLPProcess() {
     ...
     * @return a CoreNLP instance
     */
    public static CoreNLPProcess getInstance(Properties props) {
	if (pipeline == null) {
	    log.info("Initializing a Stanford Core NLP instance...");
	    coreNLP = new CoreNLPProcess(props);
	}
	return coreNLP;
    }
	...
	CoreNLPProcess cnp = CoreNLPProcess.getInstance();
