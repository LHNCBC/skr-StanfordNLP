...
public class CoreNLPWrapper {
	...
	CoreNLPWrapper nlpWrappter = CoreNLPWrapper.getInstance();
	...
	if (inFile.isDirectory()) {
		...
		nlpWrappter.coreNLP(in, out);
	}
	// String sent = "Cognitive and behavioral assessment in the early stages of neurodegenerative extrapyramidal syndromes.";
	/*- String sent = "This time around, they are moving even faster.";
	CoreNLPWrapper nlpWrapper = CoreNLPWrapper.getInstance();
	Document doc = new Document("1", sent);
	nlpWrapper.coreNLP(doc);
