...
public class SocketHandler392 extends Thread {
    final BufferedInputStream bis;
    final BufferedOutputStream bos;
    final Socket socket;
    static CoreNLPStanford392 cnp392;

    public SocketHandler392(Socket s, BufferedInputStream bis, BufferedOutputStream bos, CoreNLPStanford392 cnp) {
	this.socket = s;
	this.bis = bis;
	this.bos = bos;
	this.cnp392 = cnp;
